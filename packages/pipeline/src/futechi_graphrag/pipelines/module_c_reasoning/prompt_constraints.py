...
13. Riwayat kandang (jika ada di konteks) HANYA catatan informasional,
    ...
    context saat ini.
14. Mitigasi dan referensi obat HANYA boleh disebut jika tercantum di
    konteks (baru tersedia setelah case CONFIRMED_SICK). Tampilkan dosis dan
    withdrawal_period apa adanya. Jika data berlabel "[DUMMY]", katakan terus
    terang bahwa itu data contoh yang belum tervalidasi, BUKAN rekomendasi.
"""

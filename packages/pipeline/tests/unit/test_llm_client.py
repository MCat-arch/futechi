...
class FakeCompletions:
    ...
    def create(self, **kwargs):
        ...
        finish_reason = "length" if content == TRUNCATED else "stop"
...
def test_truncated_response_raises_without_repair_attempt() -> None:
    client, completions = _client([TRUNCATED, '{"answer": "ok"}'])
    with pytest.raises(LLMResponseTruncatedError, match="LLM_MAX_TOKENS"):
        client.generate_structured("sys", "tanya", Answer)

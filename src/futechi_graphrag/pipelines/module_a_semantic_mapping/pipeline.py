...
def run_module_semantic_mapping_pipeline(
    ...
    *,
    ...
    vocabulary = ontology.visual_feature_catalog(observation_targets)
    alias_map = ontology.alias_map(term.name for term in vocabulary)

    extraction = extract_frame_features(frames, mllm_client, vocabulary, capture_quality)
